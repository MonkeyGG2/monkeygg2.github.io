    ...
    createWaflash = (t, e) => {
                ...
                hal: {
                    url_transformRequestUrl(t) {
                        ...
                        const n = (function (t) {
                            ...
                            return [".kakaocdn.net", ".github.io", ".waflash.io", "waflash.cdn.ntruss.com", ".silvergames.com", ".codeberg.page", ".netlify.app",  ".vercel.app"].some((e) => t.indexOf(e) > 0) ? t.replace("http://", "https://") : null;
                        })(t);
        ...
        (window.waflash = a),
            (window.onerror = (t, e, n, s, o) => {
                ...
                a.ga && a.ga("event", document.location.origin, { event_category: "error", event_label: l, non_interaction: !0, send_to: a.gid });
            }),
